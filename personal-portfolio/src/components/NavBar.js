        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="https://drive.google.com/file/d/1T7t7j2CrPDftyuDFa9J2vO-3FM3hkl2t/view?usp=sharing" target="_blank" rel="noopener noreferrer" download className={activeLink === 'experience' ? 'active navbar-link' : 'navbar-link'}>Resume 🔗</Nav.Link>
            </Nav>
          </Navbar.Collapse>
        </Container>
      </Navbar>
